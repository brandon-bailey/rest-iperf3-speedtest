...
var settings = {
    ...
    job: 0,
    connection: 'ethernet',
    url_dl: '/web/garbage', // path to a large file or garbage.php, used for download test. must be relative to this js file
    url_ul: '/web/empty', // path to an empty file, used for upload test. must be relative to this js file
    url_ping: '/web/empty', // path to an empty file, used for ping test. must be relative to this js file
    url_getIp: '/web/getIp', // path to getIP.php relative to this js file, or a similar thing that outputs the client's ip
    ...
    url_telemetry: 'https://pocketfi-cloud.rmrcom.com/api/speedtest/results' // path to the script that adds telemetry data to the database
}
