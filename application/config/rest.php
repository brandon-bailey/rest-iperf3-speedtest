...
$config['match_host_to_key'] = true;

$config['rest_api_debug'] = true;
...
|
*/
$config['rest_realm'] = 'SPEEDTEST REST API';
...
|
*/
$config['rest_valid_logins'] = ['test' => 'test'];
...
// The key name that belongs to the gitlab webhooks
$config['gitlab_key_name'] = 'X-Gitlab-Token';
